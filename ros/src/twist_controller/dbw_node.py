...
class DBWNode(object):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in (self.linear_vel, self.angular_vel, self.current_vel):
                ...
                throttle, brake, steering = self.controller.control(self.linear_vel,
                                                                    ...
                                                                    self.dbw_enabled)
                if self.dbw_enabled:
                    rospy.loginfo("cmd: "  + str(throttle)+ " " + str(brake) + " " + str(steering))
    ...
    def twist_cb(self, msg):
        ...
        rospy.loginfo("twist got:"+str(self.linear_vel) + " " + str(self.angular_vel))

    def velocity_cb(self, msg):
        self.current_vel = msg.twist.linear.x
        rospy.loginfo("velocity got:"+str(self.current_vel))
